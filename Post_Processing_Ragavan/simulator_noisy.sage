...
class Simulator_noisy:
    ...
    def sample_error_model(self, R, m1, p, eta=1, verbose=False):
        """
        Samples vectors with the specified error model.
